...
})({"gVXOm":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "878e632e272a3d49";
"use strict";
...
},{"@babel/polyfill":"dTCHC","./mapbox":"3zDlz","./login":"7yHem","./updateSettings":"l3cGY","./stripe":"10tSC"}],"dTCHC":[function(require,module,exports,__globalThis) {
"use strict";
...
const API_URL = ''; // empty = current origin (localhost)
const login = async (email, password)=>{
    try {
        const res = await (0, _axiosDefault.default).post(`${API_URL}/api/v1/users/login`, {
            email,
            password
        });
        ...
        (0, _alerts.showAlert)('error', err.response?.data?.message || 'Login failed');
    }
};
const logout = async ()=>{
    try {
        const res = await (0, _axiosDefault.default).get(`${API_URL}/api/v1/users/logout`);
...
const updateSettings = async (data, type)=>{
    try {
        const url = type === 'password' ? `${API_URL}/api/v1/users/updateMyPassword` : `${API_URL}/api/v1/users/updateMe`;
...
const bookTour = async (tourId)=>{
    try {
        ...
        const session = await (0, _axiosDefault.default)(`${API_URL}/api/v1/bookings/checkout-session/${tourId}`);
        console.log(session);
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gVXOm","fyCGd"], "fyCGd", "parcelRequire3f2a", {})
